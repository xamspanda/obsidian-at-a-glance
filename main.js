...
- Add "*Generated by Hermes · [generation time]*" as the last line. Use the generation time provided below exactly; do not infer time from the target note date.
...
*Generated by Hermes · [generation time]*
...
Generation time: ${this.getCurrentTimestampLabel()}`;
  }
  ...
  getGeneratedAtLabel(_overview) {
    return this.getCurrentTimestampLabel();
  }
